...
function test_phase_setup_k8s_basic() {
...
function test_phase_run_k8s_basic() {
...
function test_failed_hook_phase_run_k8s_basic() {
...
function test_failed_hook_phase_setup_k8s_basic() {
